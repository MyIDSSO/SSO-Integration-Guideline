...
- [SECTION 2: WEB LOGIN, MOBILE APP SSO INTEGRATION AND DEVELOPER GUIDE](#section-2-web-login-mobile-app-sso-integration-and-developer-guide)
  ...
  - [Developer Guide for SSO Integration](#developer-guide-for-sso-integration)
    ...
    - [PHP 8 with Laravel Framework](#php-8-with-laravel-framework)
      ...
      - [Publish Configuration File](#library-installation-1)
      - [Define Scopes](#library-installation-1)
      - [Configure Return Variable](#configure-return-variable)
      - [Add Keycloak Driver](#add-keycloak-driver-1)
      - [Add Column in Model](#add-keycloak-driver-1)
      - [Add New Routes](#add-new-routes-1)
      - [Call Route Name](#add-new-routes-1)
...
- [Figure 18: Keycloak Guard Driver]
- [Figure 19: KEYCLOAK PROVIDERS DRIVER]
- [Figure 20: ADD ‘NAMA’ AND ‘NRIC’ COLUMN]
- [Figure 21: Add New Routes](#_bookmark80)
- [Figure 22: CALL ROUTE NAME ]
- [Figure 23: Environment Configuration in PHP Laravel](#_bookmark83)
- [Figure 24: openid-connect-php Library Installation](#_bookmark85)
- [Figure 25: loginWithKeycloak Function](#_bookmark87)
- [Figure 26: getAccessToken Function](#_bookmark89)
- [Figure 27: getUserInfo Function](#_bookmark91)
- [Figure 28: keycloakCallback Function](#figure-35-keycloakcallback-function)
- [Figure 29: Fetch userInfo](#_bookmark94
- [Figure 30: Store User Data](#_bookmark95)
- [Figure 31: Verify IC Number](#_bookmark96)
- [Figure 32: Add IC Number Column](#_bookmark98)
- [Figure 33: update_user Function](#_bookmark100)
- [Figure 34: linkAccount Function](#_bookmark102)
- [Figure 35: registerWithKeycloak Function](#_bookmark104)
- [Figure 36: LOGOUT FUNCTION]
- [Figure 37: Add New Routes](#_bookmark106)
- [Figure 38: Setup Configuration](#_bookmark109)
- [Figure 39: oauth2-client Library Installation](#_bookmark111)
- [Figure 40: Add New Construct](#_bookmark113)
- [Figure 41: login Function](#_bookmark115)
- [Figure 42: callback Function](#_bookmark117)
- [Figure 43: Fetch User Information](#_bookmark118)
- [Figure 44: Verify IC Number](#_bookmark119)
- [Figure 45: show_modal_options Functions](#_bookmark121)
- [Figure 46: link_existing_account Function](#_bookmark123)
- [Figure 47: register_new_account Function Part 1](#_bookmark125)
- [Figure 48: register_new_account Function Part 2](#_bookmark126)
